    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {/* Antes era un boton sin onClick. Ahora lleva a la seccion que ya existe. */}
          <a
            href="#roadmap"
            className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg px-4 py-2 text-sm font-medium transition-all bg-surface-container-highest text-on-surface hover:bg-outline-variant/20 focus:outline-none focus:ring-2 focus:ring-primary"
          >
